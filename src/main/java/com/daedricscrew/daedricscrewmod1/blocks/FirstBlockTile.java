...
import static com.daedricscrew.daedricscrewmod1.blocks.ModBlocks.FIRSTBLOCK_TILE;

public class FirstBlockTile extends TileEntity implements ITickableTileEntity {
    private IItemHandler handler = LazyOptional.of(() -> (T) getHandler()).cast();
    public FirstBlockTile() {
        super(FIRSTBLOCK_TILE);
    }
    @Override
    public void tick() {
        // run 2 times every tick
    }
    @Override
